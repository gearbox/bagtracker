...
def get_chain(chain_id: str, chain_manager: Annotated[ChainManager, Depends(ChainManager)]) -> Chain:
...
def delete_chain(chain_id: str, chain_manager: Annotated[ChainManager, Depends(ChainManager)]) -> None:
